...
const KeyBindsSchema = z.object({
  ...
  Game_Conveyor_Card1: z.string().optional(),
  Game_Conveyor_Card2: z.string().optional(),
  Game_Conveyor_Card3: z.string().optional(),
  Game_Conveyor_Card4: z.string().optional(),
  Game_Conveyor_Card5: z.string().optional(),
  Game_Conveyor_Card6: z.string().optional(),
  Game_Conveyor_Card7: z.string().optional(),
  Game_Conveyor_Card8: z.string().optional(),
  Game_Conveyor_Card9: z.string().optional(),
  Game_Conveyor_Card10: z.string().optional(),
